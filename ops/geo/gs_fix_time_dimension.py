"""
================================================================================
@File    :   gs_fix_time_dimension.py
@Desc    :   修复 GeoServer 时间维度配置的补丁工具。自动生成符合 time 维度的 
             indexer.properties 和 timeregex.properties，并强制清理旧索引及 
             H2 数据库，确保栅格滑块按时间轴正常工作。
@Usage   :   python ops/gs_fix_time_dimension.py
@Deps    :   os, shutil
================================================================================
"""
import os
