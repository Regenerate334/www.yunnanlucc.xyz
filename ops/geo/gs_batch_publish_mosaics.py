"""
================================================================================
@File    :   gs_batch_publish_mosaics.py
@Desc    :   批量发布全省县域 CLCD 影像金字塔图层到 GeoServer。支持 SLD 样式 
             自动化配置、时序维度（Time Dimension）开启以及范围自动重计算。
@Usage   :   python ops/geo/gs_batch_publish_mosaics.py
@Deps    :   requests, os
================================================================================
"""
import requests
