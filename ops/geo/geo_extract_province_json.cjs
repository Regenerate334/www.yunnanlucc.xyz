/**
 * ================================================================================
 * @File    :   geo_extract_province_json.cjs
 * @Desc    :   从完整的云南省级 GeoJSON 中单独提取"云南省"Feature，输出一个
 *              仅含省级几何的精简文件供前端轮廓渲染使用。
 * @Usage   :   node ops/data/geo_extract_province_json.cjs
 * @Deps    :   fs, path (Node.js 内置)
 * ================================================================================
 */
const fs = require('fs');
