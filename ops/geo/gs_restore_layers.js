/**
 * ================================================================================
 * @File    :   gs_restore_layers.js
 * @Desc    :   GeoServer 图层灾备恢复工具。批量重新发布 1985-2023 全省 CLCD 
 *              年度栅格图层（GeoTIFF → CoverageStore → Coverage → Style）。
 * @Usage   :   node ops/data/gs_restore_layers.js
 * @Deps    :   dotenv, fs
 * ================================================================================
 */
