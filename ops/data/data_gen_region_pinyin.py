"""
================================================================================
@File    :   data_gen_region_pinyin.py
@Desc    :   基于云南方言/地名习惯自动生成地州和区县拼音映射表的工具。扫描 GeoJSON 
             边界文件并输出前端使用的 region_pinyin_map.json。
@Usage   :   python ops/data/data_gen_region_pinyin.py
@Deps    :   json, pypinyin
================================================================================
"""
import json
