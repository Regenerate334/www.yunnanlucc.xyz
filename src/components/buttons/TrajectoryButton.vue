<!-- TrajectoryButton: 重心轨迹入口组件 -->
<template>
    <div class="spatial-stats-entry">
        <button @click="toggleModal" class="control-btn trajectory-btn-trigger" :class="{ active: isModeActive || isVisible }" title="重心轨迹迁移">
            <img :src="statsIcon" class="stats-icon" alt="图标" />
            <span class="btn-label">重心轨迹</span>
        </button>
...
import TrajectoryControl from '../controls/TrajectoryControl.vue';
import { useGlobalStore } from '../../stores/global';

const globalStore = useGlobalStore();
const panelName = 'trajectory';
